...
def main(i):
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for input_ids, input_mask, segment_ids,all_valid_audio,label_ids in tqdm(eval_dataloader, desc="Evaluating"):
                ...
                with torch.no_grad():
                    ...
                    logits,_,_,trace = model(input_ids,all_valid_audio, segment_ids, input_mask)
    ...
    if args.do_test:
        ...
        model.to(device)
#         model.BertFinetun.f_thres = 150
#         model.BertFinetun.b_thres = 151
        model.eval()
        ...
        with torch.no_grad():
            for input_ids, input_mask, segment_ids, label_ids, all_test_audio in tqdm(test_dataloader, desc="Evaluating"):
                ...
                with torch.no_grad():
                    ...
                    logits,text_attention,fusion_attention,trace = model(input_ids, all_test_audio,segment_ids, input_mask)
...
#                 abs_trace.append(trace['rel_trace'])
